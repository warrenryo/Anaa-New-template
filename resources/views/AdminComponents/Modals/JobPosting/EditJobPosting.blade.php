    ...
    <div class="hs-overlay-animation-target hs-overlay-open:scale-100 hs-overlay-open:opacity-100 scale-95 opacity-0 ease-in-out transition-all duration-200 lg:max-w-4xl lg:w-full m-3 lg:mx-auto m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
        <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
            ...
            <div class="p-4 overflow-y-auto">
                <form id="submit_form-edit" method="POST" action="{{ url('job-posting/manage/edit-job/id='.$job->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-5 ">
                            ...
                            <button type="button" id="add-skills2" class="btn btn-success w-full"><i class="fa-solid fa-plus mr-1"></i> Add Skills</button>
                            ...
                            <button type="button" id="add-qualifications2" class="btn btn-success w-full"><i class="fa-solid fa-plus mr-1"></i> Add Qualifications</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700">
                ...
                <button type="submit" form="submit_form-edit" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                    Save changes
                </button>
            </div>
        </div>
...
<script src="{{ asset('js/JobPostingJS/EditJobPosting.js') }}" defer></script>
<script>
    //RESPONSIBILITIES
    ...
    //SKILLS
    document.getElementById('add-skills2').addEventListener('click', function() {
        var newRequirement = document.createElement('div');
        newRequirement.classList.add('skill2');
        newRequirement.innerHTML = '<input id="ski" type="text" name="new_skills[]" placeholder="Add Skills" class="form-input mt-2"/>';
        document.getElementById('skills2').appendChild(newRequirement);
    });

    //QUALIFICATIONS
    document.getElementById('add-qualifications2').addEventListener('click', function() {
        var newRequirement = document.createElement('div');
        newRequirement.classList.add('qualification2');
        ...
        document.getElementById('qualifications2').appendChild(newRequirement);
    });
